...
namespace WindowsFormsApp2 {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(string name, string email, string address, int salary) {
            ...
            public string name {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("資料表 \'Table\' 中資料行 \'name\' 的值是 DBNull。", e);
                    }
                }
                set {
            ...
            public string email {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("資料表 \'Table\' 中資料行 \'email\' 的值是 DBNull。", e);
                    }
                }
                set {
            ...
            public string address {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("資料表 \'Table\' 中資料行 \'address\' 的值是 DBNull。", e);
                    }
                }
                set {
            ...
            public int salary {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("資料表 \'Table\' 中資料行 \'salary\' 的值是 DBNull。", e);
                    }
                }
                set {
...
namespace WindowsFormsApp2.Database1DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([name], [email], [address], [salary]) VALUES (@name, @" +
                "email, @address, @salary);\r\nSELECT Id, name, email, address, salary FROM [Table]" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [name] = @name, [email] = @email, [address] = @address, [salary] = @salary WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)));
SELECT Id, name, email, address, salary FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, email, address, salary FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_name, string Original_email, string Original_address, global::System.Nullable<int> Original_salary) {
        ...
        public virtual int Insert(string name, string email, string address, global::System.Nullable<int> salary) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string email, string address, global::System.Nullable<int> salary, int Original_Id, string Original_name, string Original_email, string Original_address, global::System.Nullable<int> Original_salary, int Id) {
            if ((name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string email, string address, global::System.Nullable<int> salary, int Original_Id, string Original_name, string Original_email, string Original_address, global::System.Nullable<int> Original_salary) {
            return this.Update(name, email, address, salary, Original_Id, Original_name, Original_email, Original_address, Original_salary, Original_Id);
        }
    }
